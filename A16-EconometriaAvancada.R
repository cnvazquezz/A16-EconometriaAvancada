#Aula 16 - Metodologia Box- Jenkings ~ Econometria Avancada

remove.packages("readxl")                   #Remove Pacotes
remove.packages("aTSA")                     #Remove Pacotes
remove.packages("tseries")                  #Remove Pacotes

install.packages("readxl", dependencies = T) #Ler Pacotes
install.packages("aTSA", dependencies = T)   #Ler Pacotes
install.packages("tseries", dependencies = T) #Ler Pacotes

library(readxl) #Carregando os pacotes
library(aTSA)   #Carregando os pacotes
library(tseries) #Carregando os pacotes
library("urca")  #Carregando os pacotes
